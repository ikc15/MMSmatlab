...
starttime    = '01:06:41.10'; % start of current sheet e.g. 00:33:29.00
endtime      = '01:06:52.04'; % end of current sheet e.g. 00:33:33.00
...
folder = 'G:/MMS data'; % location of data folder
%% 
files    = dir(fullfile(folder,sprintf('**/*%s*',yyyymmddHHMM))); %check for hidden files if this doesn't work.
